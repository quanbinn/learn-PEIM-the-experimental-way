...
### 矩形在智能建筑设计算法中的应用
- 感受基本的建筑设计概念
	- [建设用地面积](/chapters/矩形在智能建筑设计算法中的应用/建设用地面积.md) | [建筑红线面积](/chapters/矩形在智能建筑设计算法中的应用/建筑红线面积.md)
	- [建筑面积](/chapters/矩形在智能建筑设计算法中的应用/建筑面积.md) | [容积率](/chapters/矩形在智能建筑设计算法中的应用/容积率.md)
	- [基底占地面积](/chapters/矩形在智能建筑设计算法中的应用/基底占地面积.md) | [建筑密度](/chapters/矩形在智能建筑设计算法中的应用/建筑密度.md) 
- 随机生成矩形左下角点的坐标
	- [在一个给定的大矩形区域内的任意位置绘出一个小矩形](/chapters/矩形在智能建筑设计算法中的应用/在一个给定的大矩形区域内的任意位置绘出一个小矩形.md)
