...
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/1a1.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/1a2.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/1a3.jpg)

![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/2a1.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/2a2.jpg)

![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/3a1.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/3a2.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/3a3.jpg)

![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/4a1.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/4a2.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/4a3.jpg)

![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/5a1.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/5a2.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/5a3.jpg)
![](/images/对矩形的各种操作/对两个或多个距形的运算/计算出两个矩形的交并比/5a4.jpg)
...
def box_iou_xyxy(box1, box2):
    ...
    area_of_intersection = weight_of_intersection * width_of_intersection
