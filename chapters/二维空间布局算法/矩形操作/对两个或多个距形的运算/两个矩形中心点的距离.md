...
![](/images/二维空间布局算法/矩形操作/对两个或多个距形的运算/两个矩形中心点的距离/1a1.jpg)
![](/images/二维空间布局算法/矩形操作/对两个或多个距形的运算/两个矩形中心点的距离/1a2.jpg)
![](/images/二维空间布局算法/矩形操作/对两个或多个距形的运算/两个矩形中心点的距离/2a1.jpg)
![](/images/二维空间布局算法/矩形操作/对两个或多个距形的运算/两个矩形中心点的距离/2a2.jpg)
