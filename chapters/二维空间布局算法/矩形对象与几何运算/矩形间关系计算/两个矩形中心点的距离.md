...
![](/images/二维空间布局算法/矩形对象与几何运算/矩形间关系计算/两个矩形中心点的距离/1a1.jpg)
![](/images/二维空间布局算法/矩形对象与几何运算/矩形间关系计算/两个矩形中心点的距离/1a2.jpg)
![](/images/二维空间布局算法/矩形对象与几何运算/矩形间关系计算/两个矩形中心点的距离/2a1.jpg)
![](/images/二维空间布局算法/矩形对象与几何运算/矩形间关系计算/两个矩形中心点的距离/2a2.jpg)
...
print('两个矩形中心点的距离是：',distance_of_centers_in_two_rectangles(rect1, rect2))
